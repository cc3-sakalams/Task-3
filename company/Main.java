...
public class Main {
    ...
    private static void insertSampleStudents(Repository repo) {
        Student[] samples = {
                ...
                createStudent("S004", "Bob", "Brown", 22, "Male", "Physics", "Senior", "456-789-0123"),
                createStudent("S005", "Charlie", "Davis", 20, "Male", "Engineering", "Junior", "567-890-1234"),
                createStudent("S006", "Diana", "Evans", 21, "Female", "Chemistry", "Sophomore", "678-901-2345"),
                createStudent("S007", "Ethan", "Foster", 18, "Male", "History", "Freshman", "789-012-3456"),
                createStudent("S008", "Fiona", "Green", 23, "Female", "Literature", "Senior", "890-123-4567"),
                createStudent("S009", "George", "Harris", 20, "Male", "Business", "Sophomore", "901-234-5678"),
